...
<body>
    ...
    <!-- 领取DFS券模板start -->
    <script type="text/html" id="getDFSTpl">
        <!-- 券的展示start -->
        <div class="coupon-container">
            <span class="pos left-round"></span>
            <span class="pos right-round"></span>
            <div class=" dfs-controll getcouponDFS">
                ...
                <div class="coupon-order">
                    <input class="order-number" id="tuniu_order" type="text" placeHolder="请输入订单号">
                    <div class="btn-coupon" id="getBtnDFS">立即领取</div>
    ...
    <!-- 领取DFS券模板end -->
    <script id="requirejs" src="<?php echo $baseJsUrl?>lib/require.min.js" data-main="<?php echo $baseJsUrl?>main.js" data-page="getCouponDFS"></script>
</body>
