...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $baseCssUrl?>businessDetail.css" />
</head>
...
<body>
    <div class="wrapper">
        ...
        <div class="top">
            ...
            <div class="title"><span>商户详情</span></div>
            <a class="couponCenter translateY" href="couponCenter.html">券中心</a>
        </div>
        <!-- 顶部标题end -->
        <div class="main-view" id="mainView">
            <div class="business-pic">
                <img src="http://img4.imgtn.bdimg.com/it/u=2395910632,2735784472&fm=23&gp=0.jpg">
            </div>
            <div class="business-name">
                ...
                <p class="enTxt">
                    DFS T Galleria（Hong Kong Canton Road）
                </p>
            </div>
            <div class="business-couponList" id="businessCoupon">
                <div class="w-item-show active">
                    <a class="item" href="getCouponDFS.php">
                        <div class="coupon-type">
                            <i class="up-round"></i>
                            <span class="btn-bg-red">返</span>
                            <i class="down-round"></i>
                        </div>
                        <p class="coupon-desc">返现5%返现5%</p>
                        <span class="coupon-take btn-bg-red">领取</span>
                    </a>
                    <a class="item" href="getCouponDetail.php">
                        <div class="coupon-type">
                            <i class="up-round"></i>
                            <span class="btn-bg-blue">折</span>
                            <i class="down-round"></i>
                        </div>
                        <p class="coupon-desc">返现5%返现5%</p>
                        <span class="coupon-take btn-bg-blue">领取</span>
                    </a>
                    <a class="item" href="getCouponDetail.php">
                        <div class="coupon-type">
                            <i class="up-round"></i>
                            <span class="btn-bg-yellow">礼</span>
                            <i class="down-round"></i>
                        </div>
                        <p class="coupon-desc">返现5%返现5%</p>
                        <span class="coupon-take btn-bg-yellow">领取</span>
                    </a>
                    <a class="item" href="getCouponDetail.php">
                        <div class="coupon-type">
                            <i class="up-round"></i>
                            <span class="btn-bg-green">惠</span>
                            <i class="down-round"></i>
                        </div>
                        <span class="coupon-type "></span>
                        <p class="coupon-desc">返现5%返现5%</p>
                        <span class="coupon-take btn-bg-green">领取</span>
                    </a>
                    <a class="item" href="getCouponDetail.php">
                        <div class="coupon-type">
                            <i class="up-round"></i>
                            <span class="btn-bg-purple">金</span>
                            <i class="down-round"></i>
                        </div>
                        <p class="coupon-desc">返现5%返现5%</p>
                        <span class="coupon-take btn-bg-purple">领取</span>
                    </a>
                </div>
                <div class="showMore" id="showMore">
                <a href="javascript:;" class="showBtn" id="showBtn"><span class="look">查看更多</span><span class="num">5</span></a>
            </div>
            </div>
            <div class="business-descontainer">
                <ul>
                    <li>
                        <a href="tel:852-2302-6888">
                           852-2302-6888
                        </a>
                    </li>
                    <li>
                        中国 香港 九龙尖沙咀广东道28号力宝太阳广场
                    </li>
                    <li>
                        01月01日至12月31日：周一、周二、周三、周四、周五、周六、周日 10:00-23:00
                    </li>
                    <li>
                        关于T广场（香港T广场广东道店） 位于尖沙咀购物心脏地带，由尖沙咀地铁站出发只须步行约五分钟，游客亦可搭乘渡海小轮由中环直达尖沙嘴，方便快捷。美容化妆品牌一应俱全，而Dior美妆专柜更为全港最大。
                    </li>
                </ul>
            </div>
        </div>
        ...
        <!--正在加载提示end-->
        <input id="businessId" type="hidden" value="DFS商家" />
    </div>
    <!-- 商户下拥有的券的模板start -->
    <!--  <script type="text/html" id="couponTpl">
        <div class="w-item-show active">
            <%for(var i=0,len=list.length;i<len;i++){%>
                <a class="item" href="<%=list[i].couponLink%>">
                    <div class="coupon-type">
                        <i class="up-round"></i>
                        <span class="<%=list[i].couponBtnColor%>"><%=list[i].couponType%></span>
                        <i class="down-round"></i>
                    </div>
                    <p class="coupon-desc">
                        <%=list[i].couponName%>
                    </p>
                    <span class="coupon-take <%=list[i].couponBtnColor%>">领取</span>
                </a>
                <%}%>
        </div>
        <%if(totalCount >3) {%>
            <div class="showMore" id="showMore">
                <a href="javascript:;" class="showBtn" id="showBtn"><span class="look">查看更多</span><span class="num">(<%=totalCount%>)</span></a>
            </div>
            <%}%>
    </script> -->
    <!-- 商户下拥有的券的模板end -->
    <script id="requirejs" src="<?php echo $baseJsUrl?>lib/require.min.js" data-main="<?php echo $baseJsUrl?>main.js" data-page="businessDetail"></script>
    <script type="text/javascript">
