...
<body>
    ...
    <script type="text/html" id="couponTpl">
        ...
        <div class="coupon-container">
            ...
            <div class="dfs-controll dfs-detail">
                <div class="w business-logo">
                    <img src="<%=list.logo_url%>">
                </div>
                <div class="business-name"><%=list.pmt_main_title%>
                </div><div class="coupon-name"><span><%=list.pmt_sub_title%></span></div>
        ...
        <div class="coupon-code-container">
            <p class="code-txt"><span>优惠券码</span></p>
            <div class="coupon-codes-list" id="couponCodeList">
            </div>
            <div class="line" style="width: 100%;height: 1px;background:#e8e8e8;"></div>
        </div>
        <!-- 条形码 code码展示形式start -->
        <!-- 券的展示end -->
        <!-- 券的详情介绍start -->
    ...
    <!-- 券详情模板end -->
    <!-- code码模板start -->
    <script type="text/html" id="couponCodeTpl">
        <%for(var i=0,len=list.length;i<len;i++){%>
            <%if(i==0){%>
                <p class="coupon-info-num js_p_code select" data-code="<%=list[i].coupon_id%>">
                    <a href="javascript:void(0);" class="number-code">
                        <%=list[i].coupon_id%>
                            <span class="arrow arrow-up"></span>
                    </a>
                </p>
                <div class="code-con js_div_code coupon-code-down" data-code="<%=list[i].coupon_id%>">
                    <div class="code-pic">
                        <img src="<%=list[i].Barcode_img_url%>">
                    </div>
                    <p class="tips">小tips: 建议截屏保存到相册</p>
                </div>
                <%}else{%>
                    <p class="coupon-info-num js_p_code" data-code="<%=list[i].coupon_id%>">
                        <a href="javascript:void(0);" class="number-code">
                            <%=list[i].coupon_id%>
                                <span class="arrow arrow-up"></span>
                        </a>
                    </p>
                    <div class="code-con js_div_code coupon-code-up" data-code="<%=list[i].coupon_id%>">
                        <div class="code-pic">
                            <img src="<%=list[i].Barcode_img_url%>">
                        </div>
                        <p class="tips">小tips: 建议截屏保存到相册</p>
    ...
    <!-- code码模板start -->
    <script id="requirejs" src="<?php echo $baseJsUrl?>lib/require.min.js" data-main="<?php echo $baseJsUrl?>main.js" data-page="couponDetailDFS"></script>
</body>
