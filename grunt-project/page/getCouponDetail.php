...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="top">
            ...
            <div class="title"><span>领券详情页</span></div>
            <a class="couponCenter translateY" href="couponCenter.php">券中心</a>
        </div>
        <!-- 顶部标题end -->
        <!-- 主体渲染start -->
        <div class="mian-view" id="mainView">
        </div>
        <!-- 主体渲染end -->
        <!--自定义弹窗start-->
        <div class="w-dialog" id='updataDialog'>
        </div>
        <!--自定义弹窗end-->
        ...
        <input id="loginStatus" type="hidden" value="1" />
        <input id="loginJumpUrl" type="hidden" value="http://www.baidu.com" />
        <!-- 2个隐藏域end -->
    </div>
    <!-- 领券模板start -->
    <script type="text/html" id="getCouponTpl">
        <!-- 券的展示start -->
            ...
            <div class="coupon-controll">
                <div class="topMod">
                    <div class="con">
                        ...
                        <div class="coupon-pic" id="enlargePic">
                            <img src="<%=list.pmt_url%>">
                ...
                <div class="coupon-order">
                    <div class="btn-coupon" id="getCouponBtn">立即领取</div>
                    <div class="btn-coupon btn-useCoupon" id="getCouponAleardy">已领取</div>
                </div>
    ...
    <!-- 领券模板end -->
    <script id="requirejs" src="<?php echo $baseJsUrl?>lib/require.min.js" data-main="<?php echo $baseJsUrl?>main.js" data-page="getCouponDetail"></script>
</body>
