...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $baseCssUrl?>businessList.css" />
</head>
...
<body>
    <div class="wrapper">
        ...
        <div class="w-head">
            <div class="top">
                ...
                <div class="title"><span>商户列表</span></div>
                <a class="couponCenter translateY" href="couponCenter.php">券中心</a>
            </div>
        </div>
        <!--筛选导航start-->
        <div class="filter" id="j-filter">
            <a href="javascript:;" class="j-filter-button" data-value="" data-id="#destination" id="destinationItem"><span><span class="destination">全球</span><i></i></span></a>
            <a href="javascript:;" class="j-filter-button" data-value="" data-id="#business" id="businessItem"><span><span class="business">店铺</span><i></i></span>
                    </a>
            <a href="javascript:;" class="j-filter-button" data-value="" data-id="#type" id="typeItem"><span><span class="type">券类型</span><i></i></span>
                    </a>
        </div>
        <!--筛选导航end-->
        <!--头部end -->
        ...
        <div class="w-filter" id="j-filterC">
            <div class="box" id="destination">
                <div class="boxul destinationul">
                    <p class="hotTit">热门目的地</p>
                    <ul class="flex hotDesti" id="hotDestiTpl">
                    </ul>
                    <p class="cTit">目的地</p>
                    <ul class="flex desti" id="destiTpl">
                    </ul>
                </div>
            </div>
            <div class="box" id="business">
                <ul class="boxul businessul" id="shopTpl">
                </ul>
            </div>
        ...
        <!--筛选下的盒子内容start-->
        <!--券的列表展示start-->
        <div class="w-business-box" id="businessList">
        </div>
        <!--券的列表展示end-->
        <!--正在加载提示start-->
        ...
        <!-- 隐藏域start -->
        <input id="cityId" type="hidden" data-id="0" value="">
        <input id="merchant_class_id" type="hidden"  data-id="" value="">
        <input id="coupon_type" type="hidden"  data-id="0" value="">
        <!-- 隐藏域end -->
    </div>
    <!-- 商户模板start -->
        ...
        <%for(var i=0,len=list.length;i<len;i++){%>
            <dl class="w-item">
                <dt class="business-pic">
                    <img class="ui-lazyload" src="<%=list[i].pic%>" data-original="<%=list[i].pic%>">
                </dt>
                <dd>
                    <div class="text">
                        <p class="title">
                ...
                <a href="businessDetail.php" class="item_link"></a>
            </dl>
            <%}%>
    </script>
    <!-- 商户模板start -->
    ...
    <!-- 无商户模板start -->
   <script id="requirejs" src="<?php echo $baseJsUrl?>lib/require.min.js" data-main="<?php echo $baseJsUrl?>main.js" data-page="businessList"></script>
